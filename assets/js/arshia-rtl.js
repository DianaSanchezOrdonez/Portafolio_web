...
function sendEmail() {
    ...
    if(!name){
        ...
        $('.toast-body').html('El campo nombre es requerido');
    } else if(!email){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('El campo email es requerido');
    } else if(!validateEmail(email)){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('El email no es válido');
    } else if(!subject){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('El campo asunto es requerido');
    }else if(!comments){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('El campo mensaje es requerido');
    }else {
        $.ajax({
            type: 'POST',
